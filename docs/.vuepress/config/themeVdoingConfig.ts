...
export default <VdoingThemeConfig>{
  ...
  logo: "https://s2.loli.net/2023/01/10/XohRYi1JeOkcdEI.png", // 导航栏Logo
  ...
  // bodyBgImg: [
  //   'https://s2.loli.net/2022/12/23/rFx1yJHivZonNk8.jpg',
  //   'https://s2.loli.net/2022/09/21/5aoXAi7qdTbjWkV.jpg',
  ...
  author: {
    ...
    name: "rexiamu", // 必需
    link: "https://rexiamu.github.io", // 可选的
  },

  // 博主信息，显示在首页侧边栏
  blogger: {
    avatar:
      "https://s2.loli.net/2023/01/10/XohRYi1JeOkcdEI.png",
    name: "rexiamu",
    slogan: "永远年轻，永远热泪盈眶！",
  },
  ...
  footer: {
    ...
    copyrightInfo: `
      <a href='https://rexiamu.github.io' target='_blank'>Rexiamu</a> | <a href='https://creativecommons.org/licenses/by-nc-sa/4.0/' rel='external nofollow' target='_blank'>CC BY-NC-SA 4.0</a>
    `, // 博客版权信息，支持a标签
  },
};
